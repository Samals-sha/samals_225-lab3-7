pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/samals'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Samals-sha/samals_225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('samals-225')                                                         //<------your MiamiID
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.10.109 \
